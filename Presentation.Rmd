...
values<- c(348,262,214,236,422)
region<-c("Spain","Italy","Netherlands","Austria","UK")
p<-plot_ly(type='pie', labels=region, values=values, textinfo='percent', insidetextorientation='radial')
...
classSp<-
  ...
  geom_bar(stat = "identity", width=0.5, fill="#E30B5C") +
    xlab("Hotel Name")+
    ylab("Average Score")+
    coord_flip()+
    theme(legend.position="none")
...
classIt<-
 ...
 po5<-data.frame(podio5$Hotel_Name,podio5$meanpond)
  ...
  geom_bar(stat = "identity", width=0.5, fill="#CC8899") +
    xlab("Hotel Name")+
    ylab("Average Score")+
    coord_flip()+
    theme(legend.position="none")
